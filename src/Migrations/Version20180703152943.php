...
final class Version20180703152943 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE vehicule (id INT AUTO_INCREMENT NOT NULL, type_vehicule_id INT DEFAULT NULL, dispo_vehicule_id INT DEFAULT NULL, agence_id INT DEFAULT NULL, marque_id INT DEFAULT NULL, modele VARCHAR(255) DEFAULT NULL, num_serie VARCHAR(255) DEFAULT NULL, couleur VARCHAR(255) DEFAULT NULL, plaque_imma VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL , nb_km INT DEFAULT NULL, date_achat DATETIME DEFAULT NULL, prix_achat DOUBLE PRECISION DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_292FFF1D153E280 (type_vehicule_id), INDEX IDX_292FFF1D96D74F5E (dispo_vehicule_id), INDEX IDX_292FFF1DD725330D (agence_id), INDEX IDX_292FFF1D4827B9B2 (marque_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
